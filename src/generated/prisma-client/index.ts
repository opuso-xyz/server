...
export interface TodoCreateInput {
  id?: Maybe<ID_Input>;
  title: String;
  tags?: Maybe<TodoCreatetagsInput>;
  content: String;
  owner: UserCreateOneWithoutTodosInput;
  complete: Boolean;
}

export interface TodoCreatetagsInput {
...
export interface TodoUpdateInput {
  title?: Maybe<String>;
  tags?: Maybe<TodoUpdatetagsInput>;
  content?: Maybe<String>;
...
export const Prisma = makePrismaClientClass<ClientConstructor<Prisma>>({
  typeDefs,
  models,
  endpoint: `https://us1.prisma.sh/public-fancyplayer-31/todo-backend/dev`
});
